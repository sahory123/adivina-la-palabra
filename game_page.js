...
function send(){
    ...
    check_button = "<br<br<button class='btn btn-info' onclick='check()'>comprobar</check_button>";
...
function check(){
    ...
    if(answer_turn == "player1"){
        answer_turn = "player2"
        document.getElementById("player_answer").innerHTML = "turno para respander -"+player2_name;
    }
    else
    {
        answer_turn = "player1"
